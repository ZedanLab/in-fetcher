 ...
 */
export const getBlockedHosts = (): object => {
  const blockedHostsArray = blockedList.split('\n');
...
export const blockedList = `# This MVPS HOSTS file is a free download from:            #
